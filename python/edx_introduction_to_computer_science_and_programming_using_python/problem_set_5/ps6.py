...
def decrypt_story():
    """
    Returns: a tuple containing the appropriate shift and the deciphered message
    """
    encripted_message = CiphertextMessage(get_story_string())
    return encripted_message.decrypt_message()
